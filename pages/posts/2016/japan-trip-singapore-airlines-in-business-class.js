...
export default function InReview() {
  return (
    <PostLayout>
      <h1>Japan Trip: Singapore Airlines SQ11 in Business Class</h1>
      <div className="byline">12th Februaryk 2016</div>
    <p>Our first trip of 2016, and it’s a big one: we’re heading to Japan for two weeks.</p>
