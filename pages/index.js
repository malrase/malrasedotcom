  ...
  return (
    <>
      ...
      <main className="home">
        ...
        He likes <Link href="https://instagram.com/malrase">making cocktails</Link>, <Link href="https://letterboxd.com/malrase/">watching horror movies</Link>, and <Link href="https://www.goodreads.com/user/show/6233721-michael-lintorn-catlin">reading</Link>. By day, he works at Square as an engineering lead. By night, he visits bars. He lives in New York City with his husband, Hampton. 
      </main>
    </>
  )
}
